...
public class FlywayConfig {
    ...
    public Flyway flyway(
            ...
            @Value("${spring.flyway.table:auth_schema_history}") String table,
            @Value("${spring.flyway.baseline-on-migrate:true}") boolean baselineOnMigrate
    ) {
        log.info("Initializing Auth Flyway migration: locations={}, table={}, baselineOnMigrate={}",
        ...
        flyway.repair();
        flyway.migrate();
        log.info("Auth Flyway migration completed successfully.");
        return flyway;
    }
}
